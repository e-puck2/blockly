...
Blockly.Msg.THYMIO_ACTUATOR_COMM = "设置发送的红外通讯值为";
Blockly.Msg.THYMIO_ACTUATOR_COMM_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_ACTUATOR_COMM_TOOLTIP = "设置要发送的红外通讯值";
Blockly.Msg.THYMIO_ACTUATOR_MIC = "设置麦克风阈值为";
Blockly.Msg.THYMIO_ACTUATOR_MIC_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_ACTUATOR_MIC_TOOLTIP = "设置麦克风阈值";
Blockly.Msg.THYMIO_ACTUATOR_MOTOR = "将 %1 马达速度设置为 %2";
Blockly.Msg.THYMIO_ACTUATOR_MOTOR_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_ACTUATOR_MOTOR_LEFT = "左";
Blockly.Msg.THYMIO_ACTUATOR_MOTOR_RIGHT = "右";
Blockly.Msg.THYMIO_ACTUATOR_MOTOR_TOOLTIP = "设置在机器人上的马达速度";
Blockly.Msg.THYMIO_ACTUATOR_SET_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_ACTUATOR_SET_TOOLTIP = "在机器人上设置执行器变量";
Blockly.Msg.THYMIO_ACTUATOR_TIMER = "将 %1 计时器周期设置为 %2 毫秒";
Blockly.Msg.THYMIO_ACTUATOR_TIMER_FIRST = "第一";
Blockly.Msg.THYMIO_ACTUATOR_TIMER_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_ACTUATOR_TIMER_SECOND = "第二";
Blockly.Msg.THYMIO_ACTUATOR_TIMER_TOOLTIP = "在机器人上设置计时器周期变量";
Blockly.Msg.THYMIO_ARITHMETIC_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_ARITHMETIC_TOOLTIP = "计算算术表达式";
Blockly.Msg.THYMIO_BINARY = "%2 二进制 %1 %3";
Blockly.Msg.THYMIO_BINARY_AND = "和";
Blockly.Msg.THYMIO_BINARY_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_BINARY_LEFT_SHIFT = "左移";
Blockly.Msg.THYMIO_BINARY_OR = "或";
Blockly.Msg.THYMIO_BINARY_RIGHT_SHIFT = "右移";
Blockly.Msg.THYMIO_BINARY_TOOLTIP = "计算二进制表达式";
Blockly.Msg.THYMIO_BINARY_XOR = "异或";
Blockly.Msg.THYMIO_BUTTON_PRESSED = "按键 %1 按下 ";
Blockly.Msg.THYMIO_BUTTON_PRESSED_BACKWARD = "后";
Blockly.Msg.THYMIO_BUTTON_PRESSED_CENTER = "中间";
Blockly.Msg.THYMIO_BUTTON_PRESSED_FORWARD = "前";
Blockly.Msg.THYMIO_BUTTON_PRESSED_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_BUTTON_PRESSED_LEFT = "左";
Blockly.Msg.THYMIO_BUTTON_PRESSED_RIGHT = "右";
Blockly.Msg.THYMIO_BUTTON_PRESSED_TOOLTIP = "检测按键是否按下";
Blockly.Msg.THYMIO_COMMUNICATION = "%1 红外通讯";
Blockly.Msg.THYMIO_COMMUNICATION_DISABLE = "关";
Blockly.Msg.THYMIO_COMMUNICATION_ENABLE = "开";
Blockly.Msg.THYMIO_COMMUNICATION_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_COMMUNICATION_TOOLTIP = "控制机器人的通讯功能";
Blockly.Msg.THYMIO_DECLARE_ARRAY = "将 %1 声明为大小为 %2 的数组";
Blockly.Msg.THYMIO_DECLARE_ARRAY_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_DECLARE_ARRAY_TOOLTIP = "声明一定大小的数组";
Blockly.Msg.THYMIO_EVENT_BUTTON = "在%1按钮上%2";
Blockly.Msg.THYMIO_EVENT_BUTTON_BACKWARD = "后退";
Blockly.Msg.THYMIO_EVENT_BUTTON_CENTER = "中间";
Blockly.Msg.THYMIO_EVENT_BUTTON_FORWARD = "前进";
Blockly.Msg.THYMIO_EVENT_BUTTON_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_BUTTON_LEFT = "左";
Blockly.Msg.THYMIO_EVENT_BUTTON_PRESS = "按下";
Blockly.Msg.THYMIO_EVENT_BUTTON_RELEASE = "释放";
Blockly.Msg.THYMIO_EVENT_BUTTON_RIGHT = "右";
Blockly.Msg.THYMIO_EVENT_BUTTON_TOOLTIP = "对按钮按下或释放事件作出回应";
Blockly.Msg.THYMIO_EVENT_PROX = "在距离传感器%1上检测到%2";
Blockly.Msg.THYMIO_EVENT_PROX_FRONT_LEFT = "左前";
Blockly.Msg.THYMIO_EVENT_PROX_FRONT_LEFT_MIDDLE = "左前/前中";
Blockly.Msg.THYMIO_EVENT_PROX_FRONT_MIDDLE = "前中";
Blockly.Msg.THYMIO_EVENT_PROX_FRONT_RIGHT = "右前";
Blockly.Msg.THYMIO_EVENT_PROX_FRONT_RIGHT_MIDDLE = "右前/前中";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND = "地面传感器 %1 探测到 %2";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_BLACK = "黑";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_LEFT = "左";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_NOPROX = "未探测到";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_PROX = "探测到";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_RIGHT = "右";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_TOOLTIP = "对地面传感器探测事件作出回应";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_WHITE = "白";
Blockly.Msg.THYMIO_EVENT_PROX_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_PROX_NOPROX = "未探测到";
Blockly.Msg.THYMIO_EVENT_PROX_PROX = "探测到";
Blockly.Msg.THYMIO_EVENT_PROX_REAR_LEFT = "左后";
Blockly.Msg.THYMIO_EVENT_PROX_REAR_RIGHT = "右后";
Blockly.Msg.THYMIO_EVENT_PROX_TOOLTIP = "对距离传感器探测事件作出回应";
Blockly.Msg.THYMIO_EVENT_RECEIVE = "接收 %1 ";
Blockly.Msg.THYMIO_EVENT_RECEIVE_COMM = "接收红外信号";
Blockly.Msg.THYMIO_EVENT_RECEIVE_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_RECEIVE_RC = "接收遥控器信号";
Blockly.Msg.THYMIO_EVENT_RECEIVE_TOOLTIP = "对接收事件作出回应";
Blockly.Msg.THYMIO_EVENT_SHOCK = "检测到震动";
Blockly.Msg.THYMIO_EVENT_SHOCK_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_SHOCK_TOOLTIP = "对振动事件作出回应";
Blockly.Msg.THYMIO_EVENT_SOUND = "声音 %1";
Blockly.Msg.THYMIO_EVENT_SOUND_FINISHED = "结束播放";
Blockly.Msg.THYMIO_EVENT_SOUND_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_SOUND_MIC = "强度高于阀值";
Blockly.Msg.THYMIO_EVENT_SOUND_TOOLTIP = "对声音事件作出回应";
Blockly.Msg.THYMIO_EVENT_TIMER = "计时器 %1 计时结束";
Blockly.Msg.THYMIO_EVENT_TIMER_FIRST = "第一";
Blockly.Msg.THYMIO_EVENT_TIMER_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_TIMER_SECOND = "第二";
Blockly.Msg.THYMIO_EVENT_TIMER_TOOLTIP = "对计时器完成事件作出回应";
Blockly.Msg.THYMIO_EVENT_UPDATE = "当 %1 已更新";
Blockly.Msg.THYMIO_EVENT_UPDATE_ACC = "加速度计";
Blockly.Msg.THYMIO_EVENT_UPDATE_BUTTONS = "按键值";
Blockly.Msg.THYMIO_EVENT_UPDATE_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_UPDATE_MOTOR = "马达";
Blockly.Msg.THYMIO_EVENT_UPDATE_PROX = "距离传感器";
Blockly.Msg.THYMIO_EVENT_UPDATE_TEMPERATURE = "温度传感器";
Blockly.Msg.THYMIO_EVENT_UPDATE_TOOLTIP = "对更新事件作出回应";
Blockly.Msg.THYMIO_FOR_DO = "执行";
Blockly.Msg.THYMIO_FOR_FOR = "为";
Blockly.Msg.THYMIO_FOR_FROM = "从";
Blockly.Msg.THYMIO_FOR_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_FOR_TO = "至";
Blockly.Msg.THYMIO_FOR_TOOLTIP = "从起始值到结束值对变量进行计数";
Blockly.Msg.THYMIO_GET_ARRAY = "数组 %1 元素 %2";
Blockly.Msg.THYMIO_GET_ARRAY_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_GET_ARRAY_TOOLTIP = "获取数组元素的值";
Blockly.Msg.THYMIO_LED = "设置LED %1 为 %2";
Blockly.Msg.THYMIO_LED_BOTTOM_LEFT = "左下";
Blockly.Msg.THYMIO_LED_BOTTOM_RIGHT = "右下";
Blockly.Msg.THYMIO_LED_BUTTON = "按键LED指示灯 前 %1 右 %2 后 %3 左 %4";
Blockly.Msg.THYMIO_LED_BUTTON_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_BUTTON_TOOLTIP = "设置按键LED指示灯状态";
Blockly.Msg.THYMIO_LED_CIRCLE = "环形指示灯 前 %1 右前 %2 右 %3 右后 %4 后 %5 左后 %6 左 %7 左前 %8";
Blockly.Msg.THYMIO_LED_CIRCLE_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_CIRCLE_TOOLTIP = "设置环形指示灯状态";
Blockly.Msg.THYMIO_LED_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_OFF = "关闭 %1";
Blockly.Msg.THYMIO_LED_OFF_BOTTOM_LEFT = "左下 LED";
Blockly.Msg.THYMIO_LED_OFF_BOTTOM_RIGHT = "右下 LED";
Blockly.Msg.THYMIO_LED_OFF_BUTTONS = "按键 LEDs";
Blockly.Msg.THYMIO_LED_OFF_CIRCLE = "环形 LEDs";
Blockly.Msg.THYMIO_LED_OFF_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_OFF_MICROPHONE = "麦克风 LED";
Blockly.Msg.THYMIO_LED_OFF_PROX_H = "距离传感器 LEDs";
Blockly.Msg.THYMIO_LED_OFF_PROX_V = "地面传感器 LEDs";
Blockly.Msg.THYMIO_LED_OFF_RC = "遥控器 LED";
Blockly.Msg.THYMIO_LED_OFF_TEMPERATURE = "温度传感器 LEDs";
Blockly.Msg.THYMIO_LED_OFF_TOOLTIP = "关闭LED指示灯";
Blockly.Msg.THYMIO_LED_OFF_TOP = "顶部 LED";
Blockly.Msg.THYMIO_LED_PROX = "距离传感器LED指示灯 左前 %1 左前/中 %2 前中/左 %3 前中/右 %4 右前/中 %5 右前 %6 左后 %7 右后 %8";
Blockly.Msg.THYMIO_LED_PROX_GROUND = "地面传感器LED指示灯 左 %1 右 %2";
Blockly.Msg.THYMIO_LED_PROX_GROUND_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_PROX_GROUND_TOOLTIP = "设定地面传感器LED指示灯状态";
Blockly.Msg.THYMIO_LED_PROX_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_PROX_TOOLTIP = "设定距离传感器LED指示灯状态";
Blockly.Msg.THYMIO_LED_RC_SOUND = "设置 %1 LED指示灯为 %2";
Blockly.Msg.THYMIO_LED_RC_SOUND_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_RC_SOUND_RC = "遥控器";
Blockly.Msg.THYMIO_LED_RC_SOUND_SOUND = "麦克风";
Blockly.Msg.THYMIO_LED_RC_SOUND_TOOLTIP = "设置遥控器和声音传感器LED指示灯状态";
Blockly.Msg.THYMIO_LED_RGB = "设置LED %1 RGB值为 红 %2 绿 %3 蓝 %4";
Blockly.Msg.THYMIO_LED_RGB_BOTTOM_LEFT = "左下";
Blockly.Msg.THYMIO_LED_RGB_BOTTOM_RIGHT = "右下";
Blockly.Msg.THYMIO_LED_RGB_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_RGB_TOOLTIP = "使用RGB值设定LED灯颜色";
Blockly.Msg.THYMIO_LED_RGB_TOP = "顶部";
Blockly.Msg.THYMIO_LED_TEMPERATURE = "温度传感器LED指示灯 红 %1 蓝 %2";
Blockly.Msg.THYMIO_LED_TEMPERATURE_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_TEMPERATURE_TOOLTIP = "设置温度传感器LED指示灯状态";
Blockly.Msg.THYMIO_LED_TOOLTIP = "将LED灯设置为指定颜色";
Blockly.Msg.THYMIO_LED_TOP = "顶部";
Blockly.Msg.THYMIO_MOTORS_START = "以速度 %2 启动马达 %1 ";
Blockly.Msg.THYMIO_MOTORS_START_BACKWARD = "后退";
Blockly.Msg.THYMIO_MOTORS_START_FORWARD = "前进";
Blockly.Msg.THYMIO_MOTORS_START_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_MOTORS_START_SPINCCW = "逆时针旋转";
Blockly.Msg.THYMIO_MOTORS_START_SPINCW = "顺时针旋转";
Blockly.Msg.THYMIO_MOTORS_START_TOOLTIP = "启动马达";
Blockly.Msg.THYMIO_MOTORS_START_TURNBACKWARDLEFT = "左后方";
Blockly.Msg.THYMIO_MOTORS_START_TURNBACKWARDRIGHT = "右后方";
Blockly.Msg.THYMIO_MOTORS_START_TURNLEFT = "左转";
Blockly.Msg.THYMIO_MOTORS_START_TURNRIGHT = "右转";
Blockly.Msg.THYMIO_MOTORS_STOP = "停止马达";
Blockly.Msg.THYMIO_MOTORS_STOP_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_MOTORS_STOP_TOOLTIP = "停止马达";
Blockly.Msg.THYMIO_PROX_CHECK = "%1 传感器探测到 %2";
Blockly.Msg.THYMIO_PROX_CHECK_FRONT_LEFT = "左前";
Blockly.Msg.THYMIO_PROX_CHECK_FRONT_LEFT_MIDDLE = "左前/中";
Blockly.Msg.THYMIO_PROX_CHECK_FRONT_MIDDLE = "前中";
Blockly.Msg.THYMIO_PROX_CHECK_FRONT_RIGHT = "右前";
Blockly.Msg.THYMIO_PROX_CHECK_FRONT_RIGHT_MIDDLE = "右前/中";
Blockly.Msg.THYMIO_PROX_CHECK_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_PROX_CHECK_NOPROX = "未探测到";
Blockly.Msg.THYMIO_PROX_CHECK_PROX = "距离传感器";
Blockly.Msg.THYMIO_PROX_CHECK_REAR_LEFT = "左后";
Blockly.Msg.THYMIO_PROX_CHECK_REAR_RIGHT = "右后";
Blockly.Msg.THYMIO_PROX_CHECK_TOOLTIP = "检查传感器是否被阻挡";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK = "%1 地面传感器 %2";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_BLACK = "黑";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_LEFT = "左";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_NOPROX = "未探测到";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_PROX = "探测到";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_RIGHT = "右";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_TOOLTIP = "检查传感器是否被阻挡";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_WHITE = "白";
Blockly.Msg.THYMIO_SENSOR_ACC = "加速度传感器 %1 值";
Blockly.Msg.THYMIO_SENSOR_ACC_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_ACC_TOOLTIP = "检索加速度传感器值";
Blockly.Msg.THYMIO_SENSOR_ACC_X = "x";
Blockly.Msg.THYMIO_SENSOR_ACC_Y = "y";
Blockly.Msg.THYMIO_SENSOR_ACC_Z = "z";
Blockly.Msg.THYMIO_SENSOR_COMM = "接收到的红外通讯值";
Blockly.Msg.THYMIO_SENSOR_COMM_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_COMM_TOOLTIP = "检索接收到的红外通讯值";
Blockly.Msg.THYMIO_SENSOR_MIC = "麦克风强度值";
Blockly.Msg.THYMIO_SENSOR_MIC_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_MIC_TOOLTIP = "检索麦克风强度值";
Blockly.Msg.THYMIO_SENSOR_MOTOR = "马达 %1 速度";
Blockly.Msg.THYMIO_SENSOR_MOTOR_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_MOTOR_LEFT = "左";
Blockly.Msg.THYMIO_SENSOR_MOTOR_RIGHT = "右";
Blockly.Msg.THYMIO_SENSOR_MOTOR_TOOLTIP = "检索马达的速度";
Blockly.Msg.THYMIO_SENSOR_PROX = "%1 传感器的接近度";
Blockly.Msg.THYMIO_SENSOR_PROX_FRONT_LEFT = "左前";
Blockly.Msg.THYMIO_SENSOR_PROX_FRONT_LEFT_MIDDLE = "左前/中";
Blockly.Msg.THYMIO_SENSOR_PROX_FRONT_MIDDLE = "前中";
Blockly.Msg.THYMIO_SENSOR_PROX_FRONT_RIGHT = "右前";
Blockly.Msg.THYMIO_SENSOR_PROX_FRONT_RIGHT_MIDDLE = "右前/中";
Blockly.Msg.THYMIO_SENSOR_PROX_GROUND_LEFT = "地面/左";
Blockly.Msg.THYMIO_SENSOR_PROX_GROUND_RIGHT = "地面/右";
Blockly.Msg.THYMIO_SENSOR_PROX_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_PROX_REAR_LEFT = "左后";
Blockly.Msg.THYMIO_SENSOR_PROX_REAR_RIGHT = "右后";
Blockly.Msg.THYMIO_SENSOR_PROX_TOOLTIP = "检索接近传感器的接近度";
Blockly.Msg.THYMIO_SENSOR_RC = "接收到遥控器 %1 值";
Blockly.Msg.THYMIO_SENSOR_RC_ADDRESS = "地址";
Blockly.Msg.THYMIO_SENSOR_RC_COMMAND = "命令";
Blockly.Msg.THYMIO_SENSOR_RC_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_RC_TOOLTIP = "检索遥控传感器值";
Blockly.Msg.THYMIO_SENSOR_TEMPERATURE = "温度传感器值";
Blockly.Msg.THYMIO_SENSOR_TEMPERATURE_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_TEMPERATURE_TOOLTIP = "检索温度传感器值";
Blockly.Msg.THYMIO_SET_ARRAY = "将数组 %1 元素 %2 设置为 %3";
Blockly.Msg.THYMIO_SET_ARRAY_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_SET_ARRAY_TOOLTIP = "设置一个数组元素的值";
Blockly.Msg.THYMIO_SOUND_NOTE = "播放频率为 %1 Hz 音符 %2/60 秒 ";
Blockly.Msg.THYMIO_SOUND_NOTE_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_SOUND_NOTE_TOOLTIP = "在指定时间内播放某一频率的音符";
Blockly.Msg.THYMIO_SOUND_STOP = "停止播放声音";
Blockly.Msg.THYMIO_SOUND_STOP_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_SOUND_STOP_TOOLTIP = "停止播放声音";
Blockly.Msg.THYMIO_SOUND_SYSTEM = "播放声音 %1 ";
Blockly.Msg.THYMIO_SOUND_SYSTEM_ARROW = "箭头";
Blockly.Msg.THYMIO_SOUND_SYSTEM_CENTRAL = "中心";
Blockly.Msg.THYMIO_SOUND_SYSTEM_COLLISION = "冲突";
Blockly.Msg.THYMIO_SOUND_SYSTEM_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_SOUND_SYSTEM_SCARY = "惊吓";
Blockly.Msg.THYMIO_SOUND_SYSTEM_SHUTDOWN = "关闭";
Blockly.Msg.THYMIO_SOUND_SYSTEM_STARTUP = "开始";
Blockly.Msg.THYMIO_SOUND_SYSTEM_TARGET_DETECTED = "探测到目标";
Blockly.Msg.THYMIO_SOUND_SYSTEM_TARGET_FRIENDLY = "友好型目标";
Blockly.Msg.THYMIO_SOUND_SYSTEM_TOOLTIP = "播放系统声音";
Blockly.Msg.THYMIO_SUBROUTINE_DEFINE_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_SUBROUTINE_DEFINE_SUBROUTINE = "子程序";
Blockly.Msg.THYMIO_SUBROUTINE_DEFINE_TOOLTIP = "定义子程序";
Blockly.Msg.THYMIO_UNARY_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_UNARY_TOOLTIP = "执行一元运算";
Blockly.Msg.THYMIO_UNNARY = "%1 %2";
Blockly.Msg.THYMIO_UNNARY_ABSOLUTE = "绝对";
Blockly.Msg.THYMIO_UNNARY_BINARY_NOT = "二进制 否";
Blockly.Msg.THYMIO_UNNARY_NEGATIVE = "负";
Blockly.Msg.THYMIO_VARIABLE_SET = "设置 %1 为 %2";
Blockly.Msg.THYMIO_WHEN_DO = "执行";
Blockly.Msg.THYMIO_WHEN_HELPURL = "https://www.thymio.org/en:thymiotutorielp2";
Blockly.Msg.THYMIO_WHEN_TOOLTIP = "检查状况是否有变化";
Blockly.Msg.THYMIO_WHEN_WHEN = "当";

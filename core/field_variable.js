...
Blockly.FieldVariable.dropdownChange = function(text) {
    ...
    if (text == Blockly.Msg.RENAME_VARIABLE) {
        ...
        Blockly.prompt(Blockly.Msg.RENAME_VARIABLE_TITLE.replace('%1', oldVar),
                       oldVar, (text) => {
            if (text) {
        ...
        Blockly.prompt(Blockly.Msg.NEW_VARIABLE_TITLE, '', (text) => {
            var newVar = text.replace(/[\s\xa0]+/g, ' ').replace(/^ | $/g, '');
